...
namespace kraEngineSDK {
  ...
  Vector3 Vector3::ONEX = Vector3(1.0f, 0.0f, 0.0f);

  Vector3 Vector3::ONEY = Vector3(0.0f, 1.0f, 0.0f);

  Vector3 Vector3::ONEZ = Vector3(0.0f, 0.0f, 1.0f);

  Vector3 Vector3::UP = ONEY;

  Vector3 Vector3::FRONT = ONEZ;

  Vector3 Vector3::RIGHT = ONEX;
